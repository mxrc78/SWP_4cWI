...
<ul class="pricing-features">
    <li class="pricing-features-item">made out of sustainable wood</li>
</ul>
<span class="pricing-price">75€</span>
<button class ="count" @click="enteredAmount1+=1 "> +</button>
   <button class ="minus" @click="enteredAmount1-=1, amountDecks()">-</button>
   <h1> Amount: {{ enteredAmount1 }}</h1>
   <button id="test" @click = "showInput =!showInput; hideOrder = !hideOrder" class="pricing-button"> BUY</button>
   </div>
   </div>
   <div class ="hide" v-if="hideOrder">
<div class="panel pricing-table">
...
<button class ="count" @click="enteredAmount2+=1 "> +</button>
   <button class ="minus" @click="enteredAmount2-=1, amountPants()">-</button>   
...
<span class="pricing-price"><div class="sale">80 € 
</div></span>
<button class ="amount" @click="enteredAmount3+=1 "> +</button>
   <button class ="minus" @click="enteredAmount3-=1, amountShoe()">-</button>
   ...
   <button id="test" @click = "showInput =!showInput; hideOrder = !hideOrder" class="pricing-button"> BUY</button>
    ...
    <button @click="takeOrder(), thankYou = !thankYou, hideOrder, showInput =!showInput">Order</button> 
...
export default {
  ...
  methods: {
    takeOrder(){
        this.$emit("add-order", this.enteredMail, this.enteredPhone, this.enteredName, this.enteredAddress)
    },
